        ...
        Alert.alert("Success", "Bill item updated successfully!", [
          {
            ...
            onPress: () =>
              router.push({
                pathname: "/admin/Bills/Maintenance/CreateScheduledBill", // Adjust this path based on your routing structure
                params: {
  ...
  return (
    <Provider>
      <View style={styles.container}>
        ...
        <AppbarComponent
          title={
            isEditMode ? "Update Schedule Bill Item" : "Add Schedule Bill Item"
          }
          source="Admin"
        />
        <KeyboardAvoidingView
...
export default AddScheduleBillItem;
